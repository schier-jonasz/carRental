...
if(isset($_POST['search'])){
    ...
    $query = mysqli_query($conn,"SELECT * FROM (SELECT * FROM samochod WHERE data_sprzedazy >'$txtEndDate' AND id_segment = 8)z LEFT JOIN (SELECT * FROM rezerwacja WHERE data_zwrotu<'$txtStarDate' OR data_wypozyczenia>'$txtEndDate')x ON x.id_samochodu = z.id");
